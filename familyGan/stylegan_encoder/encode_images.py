...
import PIL.Image
import numpy as np
import stylegan_encoder.dnnlib
...
from stylegan_encoder.encoder.perceptual_model import PerceptualModel, load_images
...
def main():
    ...
    tflib.init_tf()
    with familyGan.stylegan_encoder.dnnlib.util.open_url(args.model_url, cache_dir=familyGan.stylegan_encoder.config.cache_dir) as f:
    ...
    if (args.use_lpips_loss > 0.00000001):
        with familyGan.stylegan_encoder.dnnlib.util.open_url('https://drive.google.com/uc?id=1N2-m9qszOeVC9Tq77WxsLnuWwOedQiD2', cache_dir=familyGan.stylegan_encoder.config.cache_dir) as f:
